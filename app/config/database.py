...
DB_CONFIG = {
    'dynamodb': {
        ...
        'local': DYNAMODB_ENDPOINT is not None and (
            'localhost' in DYNAMODB_ENDPOINT or 
            'dynamodb-local' in DYNAMODB_ENDPOINT or
            '127.0.0.1' in DYNAMODB_ENDPOINT
        )
    }
}
